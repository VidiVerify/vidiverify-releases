<p align="center">
  <img src="https://vidiverify.de/logo.png" alt="VidiVerify Logo" width="160" />
</p>
...
<p align="center">
  ...
  <a href="https://github.com/VidiVerify/vidiverify-website/blob/master/LICENSE"><img src="https://img.shields.io/badge/Lizenz-GPL--3.0-22c55e?style=for-the-badge" alt="Lizenz GPL-3.0" /></a>
</p>
...
Hier liegen die **offiziellen, signierten Releases** von VidiVerify sowie der **Auto-Update-Feed** (`latest.json`). Jede `VidiVerify-Setup.exe` trägt eine Sectigo-Code-Signatur und einen SHA-256-Prüfwert. Die App prüft beim Start auf neue Versionen und installiert Updates auf Wunsch automatisch (Download → Verifikation → Silent-Install). Den Quellcode der Produktwebsite findest du unter [VidiVerify/vidiverify-website](https://github.com/VidiVerify/vidiverify-website).
...
- 🛡️ [Security Policy](https://github.com/VidiVerify/vidiverify-website/blob/master/SECURITY.md)
